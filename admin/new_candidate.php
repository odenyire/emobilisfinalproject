...
<div class="navbar">
    ...
    <li><a href="candidate_for_governor.php"><font color="white">School Captain</font></a></li>
    <li><a href="candidate_for_vice-governor.php"><font color="white">Deputy Captain</font></a></li>
    <li><a href="1st_year.php"><font color="white">Form One Rep</font></a></li>
    <li><a href="2nd_year.php"><font color="white">Form Two Rep</font></a></li>
    <li><a href="3rd_year.php"><font color="white">Form Three Rep</font></a></li>
    <li><a href="4th_year.php"><font color="white">Form Four Rep</font></a></li>
    </ul>
    </div>
	<div class="pagination">
    <ul>
   ...
   <select name="rposition" class="rposition" id="span22">
	...
	<option>Deputy Captain</option>
	<option>Form One Rep</option>
	<option>Form Two Rep</option>
	<option>Form Three Rep</option>
	<option>Form Four Rep</option>	
	</select>
    </div>
    </div>
	<div class="control-group">
