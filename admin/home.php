	...
	<div id="element" class="hero-body">
	  <div class="thumbnail_gallery">
				...
				<div id="myGallery" class="spacegallery">
					<img src="images/alliance.jpg" alt="" />
					<img src="images/alliance.jpg" alt="" />
            </div>
			</div>
			  <div class="thumbnail_mission">
			  <h2>Edutech Schools e-Vote System</h2>
			  <p>Edutech Schools e-Vote System is a digital led platform which assists in management the electioneering process in the African schools.
			  An initiative of Edutech Consultants and Technology through it's African Digital Schools Initiative, the system eliminates corruption 
			  and favoritism to candidates by teachers, thus allowing the will of the students.
			  </p>
			...
			<div class="modal-body">
			<h2>African Digital Schools Initiative</h2>
			<p><font color="black">
			The goal of African Digital Schools Inititaive is the fdigitaisation of the school aoperations ain thenSAfrican Digital Schools. 
			</p>	  
			...
			<a href="#" class="btn" data-dismiss="modal">Close</a>
			   ...
			   <h2>African Digital Schools Initiative</h2></p>
			  <p>This initiative co-ordinated by Edutech Consultants targets in the digitization of schools operations in the African schools. 
			  Through the inititiave, schools get affordable websites, school management systems, SMS and email marketing bundles, social media marketing amon gother services. 
			  </p>
