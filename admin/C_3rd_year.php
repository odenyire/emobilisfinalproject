...
<div class="navbar">
    ...
    <li class="active"><a href="C_3rd_year.php"><font color="white">Form Three Rep</font></a></li>
...
<?php $candidate_query=mysqli_query($conn,"select  * from candidate where Position='Form Three Rep'");
