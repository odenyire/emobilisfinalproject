...
<div class="navbar">
    ...
    <li><a href="C_governor.php"><font color="white">School Captain</font></a></li>
    <li  class="active"><a href="C_vice-governor.php"><font color="white">Deputy Captain</font></a></li>
    <li><a href="C_1st_year.php"><font color="white">Form One Rep</font></a></li>
    <li><a href="C_2nd_year.php"><font color="white">Form Two Rep</font></a></li>
    <li><a href="C_3rd_year.php"><font color="white">Form Three Rep</font></a></li>
    <li><a href="C_4th_year.php"><font color="white">Form Four Rep</font></a></li>
	...
	<?php
	$query=mysqli_query($conn,"select  * from candidate where Position='School Captain'");
...
<?php $candidate_query=mysqli_query($conn,"select  * from candidate where Position='Deputy Captain'");
