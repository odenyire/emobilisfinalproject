...
<div class="navbar">
    ...
    <li class="active"><a href="candidate_for_governor.php"><font color="white">School Captain</font></a></li>
    ...
    <li><a href="4th_year.php"><font color="white">Form One Rep</font></a></li>
    </ul>
    </div>
...
<?php $candidate_query=mysqli_query($conn,"select  * from candidate where Position='School Captain'");
